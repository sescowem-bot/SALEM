  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <section className="surface-card p-5 sm:p-7">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl border border-border bg-secondary/60 px-3.5 py-3"><p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Lab number</p><p className="mt-1 text-sm font-semibold text-navy-deep">Automatically generated</p><p className="mt-0.5 text-xs text-muted-foreground">Salem assigns the next unique SML number when the report is created.</p></div>
