  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <section className="surface-card p-5 sm:p-7">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-lg border border-border bg-secondary/40 p-3 text-sm"><p className="font-medium text-navy-deep">Lab number</p><p className="mt-1 text-xs text-muted-foreground">Automatically generated by Salem when the result is created.</p></div>
