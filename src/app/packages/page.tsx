...
export default async function PackagesPage(){const content=await getPublishedPageContent<PackagesContent>("packages");return <SiteLayout><PackagesPageContent content={{...defaultPackagesContent,...content,packages:content.packages?.length ? content.packages : defaultPackagesContent.packages}}/></SiteLayout>;}
