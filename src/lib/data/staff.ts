...
export async function createStaffAccount(input: {
  ...
  if (!await hasPermission(input.actorRole, "staff.manage")) {
...
export async function updateStaffProfile(
  ...
  if (!await hasPermission(actorRole, "staff.manage")) {
...
export async function countActiveStaff(actorRole: StaffRole): Promise<number> {
  if (!await hasPermission(actorRole, "staff.manage") && actorRole !== "admin") {
